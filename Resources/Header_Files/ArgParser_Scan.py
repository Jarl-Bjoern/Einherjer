...
"""
    ...
    performance_arguments.add_argument('-ps', '--process-sleep', type=float, default=7.5, help=Colors.GREEN+'Set the pauses between the process starts to do not DDoS the target.\n\nDefault: 7.5 Seconds'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
