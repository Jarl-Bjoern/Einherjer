...
"""
    ...
    config_arguments.add_argument('-rChF', '--read-custom-header-file', type=str, nargs='?', default=False, help=Colors.GREEN+'Use this parameter to specify that the customized header file will be loaded.\n\nThis value is disabled by default.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
