...
"""
    ...
    config_arguments.add_argument('-aR', '--allow-redirects', type=str, nargs='?', default=True, help=Colors.GREEN+'This parameter specifies whether forwarding should be used for web requests.\n\nDefault: True'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    config_arguments.add_argument('-rChh', '--read-config-http-header', type=str, nargs='?', default=True, help=Colors.GREEN+'With this parameter you specify that the template for the normal server headers are read in.\n\nThis value is enabled by default.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    config_arguments.add_argument('-rChhA', '--read-config-http-header-api', type=str, nargs='?', default=False, help=Colors.GREEN+'Use this parameter to specify that the template for the normal API headers are read.\n\nThis value is disabled by default.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    performance_arguments.add_argument('-fw', '--fuzzing-wait', type=int, default=0.08, help=Colors.GREEN+'This parameter specifies the default sleep between the fuzzing.\n\nDefault: 0.08 Seconds'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    scan_arguments.add_argument('-sArg', '--scan-arguments', choices=['all','http-cookie-security','http-header','http-header-api','http-screenshot','http-ssl', 'ssh'], type=str, nargs='+', help=Colors.GREEN+'UNDER CONSTRUCTION.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
