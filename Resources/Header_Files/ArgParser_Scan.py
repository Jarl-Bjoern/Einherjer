...
"""
    ...
    config_arguments.add_argument('-rChh', '--read-config-http-header', type=str, nargs='?', default=True, help=Colors.GREEN+'Use this parameter to specify that the template for the normal server headers are read.\n\nThis value is enabled by default.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    config_arguments.add_argument('-rChF', '--read-custom-header-file', type=str, nargs='?', default=False, help=Colors.GREEN+'Use this parameter to specify that the customized header file will be load.\n\nExample:\n  - {"Connection": "Close"}\n\nThis value is disabled by default.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
