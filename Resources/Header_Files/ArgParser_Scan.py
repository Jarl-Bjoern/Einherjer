...
"""
    ...
    config_arguments.add_argument('-sMcf', '--smtp-mail-config-file', type=str, help=Colors.GREEN+'UNDER CONSTRUCTION.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    format_arguments.add_argument('-f', '--format', choices=['csv','json','xlsx'], type=str, default='csv', help=Colors.GREEN+'This parameter specify the output format.'+Colors.RESET+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    format_arguments.add_argument('-fL', '--format-language', choices=['de','en'], type=str, default='en', help=Colors.GREEN+'This parameter specify the language inside the output files.'+Colors.RESET+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    format_arguments.add_argument('-sBm', '--screenshot-border-mode', choices=['Border','Drawning'], type=str, default="Drawning", help=Colors.GREEN+'This parameter specifies the mode to draw the border to the screenshots.\n\nDefault: Border'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    format_arguments.add_argument('-sF', '--screenshot-frame', nargs='?', type=bool, default=True, help=Colors.GREEN+'This parameter will deactivate the frames while taking screenshots.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    format_arguments.add_argument('-sFt', '--screenshot-frame-thickness', nargs='?', type=int, default=2, help=Colors.GREEN+'Using this parameter you can set the thickness of a frame.\n\nDefault: 2'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    performance_arguments.add_argument('-aSt', '--async-ssl-timeout', type=int, default=45, help=Colors.GREEN+'Specify the connection timeout inside the ssl ciphers scan in seconds.\n\nDefault: 45 seconds'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    performance_arguments.add_argument('-tHSo', '--thread-ssl-timeout', type=int, default=600, help=Colors.GREEN+'This parameter sets the max time to wait until a thread will be terminated.\n\nDefault: 600 Seconds'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    scan_arguments.add_argument('-sSSH', '--scan-ssh', type=bool, nargs='?', const=True, help=Colors.GREEN+'This parameter checks the target SSH service for vulnerabilities.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET, default=False)
