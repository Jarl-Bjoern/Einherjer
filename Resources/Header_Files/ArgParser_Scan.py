...
"""
    ...
    format_arguments.add_argument('-sBm', '--screenshot-border-mode', choices=['Border','Drawning'], type=str, default="Border", help=Colors.GREEN+'This parameter specifies the mode to draw the border to the screenshots.\n\nDefault: Border'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
