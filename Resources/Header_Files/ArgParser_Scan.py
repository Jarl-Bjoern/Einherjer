...
"""
    ...
    format_arguments.add_argument('-sFt', '--screenshot-frame-thickness', nargs='?', type=int, default=3, help=Colors.GREEN+'Using this parameter you can set the thickness of a frame.\n\nDefault: 3'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
