...
"""
    ...
    format_arguments.add_argument('-sF', '--screenshot-frame', nargs='?', type=bool, default=True, help=Colors.GREEN+'Using this parameter you can set frames on screenshots.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
