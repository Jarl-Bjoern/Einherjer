...
"""
    ...
    config_arguments.add_argument('-rChh', '--read-config-http-header', type=str, default=True, help=Colors.GREEN+'With this parameter you specify that the template for the normal server headers are read in.\n\nThis value is enabled by default.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    config_arguments.add_argument('-rChhA', '--read-config-http-header-api', type=str, default=False, help=Colors.GREEN+'Use this parameter to specify that the template for the normal API headers are read.\n\nThis value is disabled by default.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    performance_arguments.add_argument('-sw', '--screenshot-wait', type=int, default=15, help=Colors.GREEN+'This parameter specifies the default waiting time to connect to the target page.\n\nDefault: 15 Seconds'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    performance_arguments.add_argument('-tHo', '--thread-timeout', type=int, default=320, help=Colors.GREEN+'This parameter sets the max time to wait until a thread will be terminated.\n\nDefault: 320 Seconds'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
