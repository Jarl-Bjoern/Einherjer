...
"""
    ...
    performance_arguments.add_argument('-aSt', '--async-ssl-timeout', type=int, default=8, help=Colors.GREEN+'Specify the connection timeout inside the ssl ciphers scan in seconds.\n\nDefault: 8 seconds'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
