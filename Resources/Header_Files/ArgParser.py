...
"""
    ...
    performance_arguments.add_argument('-sw', '--screenshot-wait', type=int, default=15, help=Colors.GREEN+'This parameter specifies the default waiting time between the screenshots\n\nDefault: 15 Seconds'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
