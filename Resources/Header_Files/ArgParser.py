...
"""
    ...
    config_arguments.add_argument('-rChhA', '--read-config-http-methods', type=str, default=join(Template_Location, 'http_methods.txt'), help=Colors.GREEN+'UNDER CONSTRUCTION'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
