...
"""
    ...
    malicious_arguments.add_argument('-gMf', '--generate-malicious-files', type=str, help=Colors.GREEN+'This Parameter creates malicious files to farm hashes.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
