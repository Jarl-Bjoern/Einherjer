...
"""
    ...
    filter_arguments.add_argument('-nSSH', '--nmap-ssh-output-location', type=str, help=Colors.GREEN+'With this parameter you can include nmap files with SSH results, which are\nfiltered and then output as a CSV file.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
