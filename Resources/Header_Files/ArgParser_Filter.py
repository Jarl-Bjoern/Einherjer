...
"""
    ...
    nmap_arguments.add_argument('-nSSL', '--nmap-ssl-output-location', type=str, help=Colors.GREEN+'UNDER CONSTRUCTION'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    picture_arguments.add_argument('-sBm', '--screenshot-border-mode', choices=['Border','Drawning'], type=str, default="Drawning", help=Colors.GREEN+'This parameter specifies the mode to draw the border to the screenshots.\n\nDefault: Border'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
