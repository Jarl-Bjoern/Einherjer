...
"""
    ...
    filter_arguments.add_argument('-nL', '--nmap-files-location', type=str, help=Colors.GREEN+'With this parameter you can include nmap files with SSH results,\nwhich are filtered and then output as a CSV file.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    filter_arguments.add_argument('-sL', '--screenshot-location', type=str, help=Colors.GREEN+'Using this parameter you can specify a folder with screenshots, which will be\nloaded into the filter mode and all screenshots in it will be decorated with a black frame.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
