...
"""
    ...
    filter_arguments.add_argument('-nL', '--nmap-files-location', type=str, help=Colors.GREEN+'With this parameter you can include nmap files with SSH results, which are filtered\nand then output as a CSV file.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
