...
"""
    ...
    program_arguments.add_argument('--brute-force-mode', type=bool, nargs='?', default=False, help=Colors.GREEN+'This parameter is used to use the brute-force mode.\n\nExample:\n  - python3 Einherjer.py --brute-force-mode.\n'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
