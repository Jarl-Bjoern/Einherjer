...
"""
    ...
    program_arguments.add_argument('--detector-mode', type=bool, nargs='?', default=True, help=Colors.GREEN+'This parameter is used to use the detector mode.\n\nExample:\n  - python3 Einherjer.py --detector-mode\n'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    program_arguments.add_argument('--fuzzing-mode', type=bool, nargs='?', default=True, help=Colors.GREEN+'This parameter is used to use the fuzzing mode.\n\nExample:\n  - python3 Einherjer.py --fuzzing-mode\n'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
