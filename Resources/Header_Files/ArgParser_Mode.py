...
"""
    ...
    program_arguments.add_argument('--scanning-mode', type=bool, nargs='?', default=True, help=Colors.GREEN+'This parameter is used to use the scanning mode, to see more parameters use the help menu with "-h".\n\nExample:\n  - python3 Einherjer.py --scanning-mode -h.\n'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
