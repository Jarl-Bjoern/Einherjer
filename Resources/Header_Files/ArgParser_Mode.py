...
"""
    ...
    program_arguments.add_argument('--detector-mode', type=bool, nargs='?', default=True, help=Colors.GREEN+'UNDER CONSTRUCTION\n'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
    ...
    program_arguments.add_argument('--fuzzing-mode', type=bool, nargs='?', default=True, help=Colors.GREEN+'This parameter is used to use the filter mode.\n\nExample:\n  - python3 Einherjer.py --fuzzing-mode\n'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
