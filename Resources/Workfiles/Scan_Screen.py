...
class Web:
    def Driver_Specification(options):
        ...
        except AttributeError: Logs.Error_Message("\nIt was not possible to use the chromedriver. Please try another one or upgrade selenium and the installed chromium")
        return driver
