...
def SSL_Filter(sslyze_input_file, Location, Array_Result_Filter = ['http_headers','rejected_cipher_suites','rejected_curves'], Temp = ""):
    # Variables
    TLS_Version, Supported_Version, Array_Attack, Dict_Full_Output = "","",[],{}

    # Read sslyze output file
    with open(sslyze_input_file, 'r') as f:
        parsed_results = json_load(f)
    ...
    try:
            ...
            # Results
            for _ in parsed_results['server_scan_results']:
