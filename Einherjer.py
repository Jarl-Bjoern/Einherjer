...
def main(Date, Dict_Result = {'Header': {}, 'Information': {}, 'SSH': {}, 'SSL': {}, 'Fuzzing': {}, 'Security_Flag': {}}, Array_Switch = [], Array_Thread_Args = [], Dict_Threads = {}, Counter_Connections = 0):
    ...
    scan_arguments.add_argument('-sArg', '--scan-arguments', choices=['all','dns-fuzz','site-credentials','site-cookie-security','site-fuzzing','site-header','site-screenshot','site-screenshot-recursive','site-ssh','site-ssl'], type=str, help=Colors.GREEN+'UNDER CONSTRUCTION.'+Colors.BLUE+'\n\n-------------------------------------------------------------------------------------'+Colors.RESET)
