...
def main(Counter_Connections = 0, Dict_Result = {'Header': {}, 'Information': {}, 'SSH': {}, 'SSL': {}, 'Fuzzing': {}, 'Security_Flag': {}}):
    ...
    performance_arguments.add_argument('-mx', '--max-connections', type=int, default=cpu_count()*2, help=f'Defines the max connections via threads or processes for every try to scan. Default: {cpu_count()*2}\n-------------------------------------------------------------------------------------')
